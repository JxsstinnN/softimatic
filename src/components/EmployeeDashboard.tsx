    ...
    <div className="space-y-8">
        ...
        <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
          <div className="p-6 border-b border-slate-200">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-lg font-semibold text-slate-800">Tareas Prioritarias</h2>
                <p className="text-sm text-slate-500">Por completar en los próximos días</p>
              </div>
            </div>
          </div>
          ...
          <div className="divide-y divide-slate-100">
            {priorityTasks.map((task) => (
              <div key={task.id} className="p-6 hover:bg-slate-50 transition-colors cursor-pointer group">
                ...
                <div className="flex items-center justify-between text-xs">
                  <span className="text-slate-500">{task.assignedBy}</span>
        ...
        <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
          <div className="p-6 border-b border-slate-200">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-lg font-semibold text-slate-800">Próximas Fechas Límite</h2>
          ...
          <div className="divide-y divide-slate-100">
            {upcomingDeadlines.map((deadline) => (
              <div key={deadline.id} className="p-6 hover:bg-slate-50 transition-colors cursor-pointer group">
                <div className="flex items-start justify-between mb-3">
                  <div className="flex-1">
                    <h3 className="font-semibold text-slate-800 group-hover:text-blue-600 transition-colors mb-1">
                      {deadline.title}
                    </h3>
                    <p className="text-sm text-slate-500">{deadline.project}</p>
                  </div>
                ...
                <div className="flex items-center justify-between text-xs">
                  <span className="text-slate-500">{deadline.dueDate}</span>
      ...
      <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl border border-blue-200 p-8">
        <div className="max-w-2xl">
          <h2 className="text-2xl font-bold text-slate-800 mb-2">Excelente desempeño esta semana</h2>
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <button className="px-6 py-2.5 bg-white hover:bg-slate-50 text-slate-700 border border-slate-200 rounded-lg transition-colors font-medium">
              Ver Reportes
            </button>
          </div>
        </div>
