        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-xl font-semibold text-slate-800">Softimatic</span>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-slate-600">Gestiona tus proyectos de desarrollo de software</p>
          </div>
        ...
        <div className="bg-white rounded-lg border border-slate-200 mb-6 p-1">
